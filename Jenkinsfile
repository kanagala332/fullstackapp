pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://107.21.69.246:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    post {
        success {
            echo "✅ Backend deployed: http://107.21.69.246:9090/springapp1"
            echo "✅ Frontend deployed: http://107.21.69.246:9090/frontapp1"
        }
        failure {
